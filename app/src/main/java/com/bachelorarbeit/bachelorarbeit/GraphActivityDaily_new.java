...
public class GraphActivityDaily_new extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_daily_new);
    ...
    private void initializeClickListenerForDatePickerButton(){
        datePickerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                DatePickerDialog datePickerDialog = new DatePickerDialog(GraphActivityDaily_new.this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year,
                        ...
                        Intent reloadIntent = new Intent(GraphActivityDaily_new.this, GraphActivityDaily_new.class);
                        reloadIntent.putExtra(getResources().getString(R.string.key_date), newDate);
                        GraphActivityDaily_new.this.finish();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if(++check > 1) {
            Intent i = new Intent(getApplicationContext(), GraphActivityDaily_new.class);
